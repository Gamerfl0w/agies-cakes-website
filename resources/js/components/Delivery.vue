<template>
  <div>
    <button @click="showModal = true" class="bg-blue-800 hover:bg-blue-900 text-white py-2 px-4 rounded-t-lg text-lg font-bold w-full">
        Change Order Status
    </button>
    ...
    <div class="w-full max-w-lg relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
      ...
      <div class="">
        ...
        <div class="p-3 mt-2 text-center space-x-4 md:block">
            ...
            <button @click="handleStatus()" class="mb-2 md:mb-0 bg-green-500 border border-green-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-600">Apply</button>
        </div>
      </div>
    </div>
  </div>
    ...
    methods: {
        ...
        async handleStatus(){          
            await axios.post('/change-status', {
                ...
                .then(this.$toastr.s("Order Status: " + this.status ))
                .then(setTimeout(()=> {
            ...
            // handleReceipt(){
            // axios.get('/orders-receipt/pdf/download')  
            //     .catch(error => {
            //     console.log("ERRRR:: ",error.response.data);
            //     this.$toastr.e("Something went wrong :(")
            //     });
