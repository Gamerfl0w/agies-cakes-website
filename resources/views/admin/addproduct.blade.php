    ...
    <div class="container items-center px-5 py-12 lg:px-20">
        <form method="POST" action="{{ route('product.create') }}" enctype="multipart/form-data">
          ...
          <section class="flex flex-col p-1 overflow-auto">
            <label for="name" class="text-4xl pb-3 text-center leading-7 text-blueGray-500 mb-5">Add Product</label>
            ...
            focus:border-blue-500 focus:outline-none focus:shadow-outline focus:ring-2 bg-cover bg-center bg-no-repeat
            ring-offset-2" style="background-image: url('https://img.freepik.com/free-photo/frame-food-ingredients-baking-gently-pink-pastel-background-cooking-flat-lay-with-copy-space-top-view-baking-concept-flat-lay_127032-2200.jpg')">
              ...
              <input type="file" id="image" name="image" required class="text-black w-auto px-2 py-1 my-2 mr-2 text-blueGray-500 transition duration-500 ease-in-out transform border rounded-md hover:text-blueGray-600 text-md focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:bg-gray-100">
              @error('image')
          ...
          <div class="relative pt-4">
            ...
            <input type="text" id="name" name="name" placeholder="name" required class="w-full px-4 py-2 mt-2 mr-4 text-base text-black transition duration-500 ease-in-out transform rounded-lg bg-gray-100 focus:border-blueGray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2" required="">
            @error('name')
          ...
          <div class="relative pt-4">   
            ...
            <input type="number" id="price" name="price" placeholder="price" required class="w-full px-4 py-2 mt-2 mr-4 text-base text-black transition duration-500 ease-in-out transform rounded-lg bg-gray-100 focus:border-blueGray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2" required="">
          </div>
          <div class="flex flex-wrap mt-4 mb-6 -mx-3">
            <div class="w-full px-3">
              <label class="text-base leading-7 text-blueGray-500" for="description">Product Details </label>
              <textarea name="description" required class="w-full h-32 text-black px-4 py-2 mt-2 text-base text-blueGray-500 transition duration-500 ease-in-out transform bg-white border rounded-lg focus:border-blue-500 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 apearance-none autoexpand" id="details" type="text" name="details"></textarea>
            </div>
          </div>
