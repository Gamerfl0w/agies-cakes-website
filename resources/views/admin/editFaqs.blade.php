    ...
    <div class="container items-center px-5 py-12 lg:px-20">
        <form method="POST" action="{{ route('questions.update',$question->id) }}">
          ...
          <section class="flex flex-col p-1 overflow-auto">
            <label for="name" class="text-4xl pb-3 text-center leading-7 text-blueGray-500 mb-5">Edit FAQs</label>
          </section>           
          <div class="relative pt-4">
            <label for="question" class="text-base leading-7 text-blueGray-500">Enter Question</label>
            <textarea cols="30" rows="8"  id="name" name="question" placeholder="Question" required class="w-full px-4 py-2 mt-2 mr-4 text-base text-black transition duration-500 ease-in-out transform rounded-lg bg-gray-100 focus:border-blueGray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2" required="">
              {{ $question->question }}
            </textarea>
            @error('question')
          ...
          <div class="relative pt-4">   
            <label for="answer" class="text-base leading-7 text-blueGray-500">Enter Answer</label>
            <textarea cols="30" rows="8" id="answer" name="answer" placeholder="answer" required class="w-full px-4 py-2 mt-2 mr-4 text-base text-black transition duration-500 ease-in-out transform rounded-lg bg-gray-100 focus:border-blueGray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2" required="">
              {{ $question->answer }}
            </textarea>
          </div>
