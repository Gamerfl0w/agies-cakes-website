...
@section ('content')
<body class="bg-pink-300 text-gray-100">
  <form method="post" action="/testimonial">
    ...
    <div
      ...
      <div class="flex flex-col justify-between text-center">
        <div>
          <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Rate your experience!</h2>
      ...
      <div class="">
        <div>
          ...
          <input name="name" class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
            type="text" value="{{ auth()->user()->name ?? 0  }}">
        </div>
        {{-- <div class="mt-8">
        ...
        <div class="mt-8">
          ...
          <textarea name="message"
            class="w-full h-48 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
        </div>
        <div class="mt-8">
          <button type="submit"
            class="uppercase text-sm font-bold bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
            Send Feedback
          </button>
        </div>
      </div>
