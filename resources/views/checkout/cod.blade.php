...
<div class="bg-white flex justify-center items-center h-full flex-col">
    <div class="bg-white p-6 md:mx-auto">
      ...
      <div class="text-center">
          <h3 class="text-[50px] lg:text-4xl text-gray-900 font-semibold text-center">Order Pending</h3>
          <p class="text-[40px] lg:text-2xl text-gray-600 my-2 font-bold">Your remaining balance is PHP {{$checkOrder->total}}, please pay upon delivery.</p>
